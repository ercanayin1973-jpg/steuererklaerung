...
def create_pdf_report(ai_text, status, filename="Steuererklaerung_Mit_Steuerlast.pdf"):
    ...
    elements.append(Paragraph("<b>1. EINKOMMEN (GESAMTEINKOMMEN)</b>", meta_style))
    ...
    elements.append(Paragraph("<b>2. ABZÜGE (BERUFSAUSLAGEN, GESUNDHEIT, SPENDEN)</b>", meta_style))
    elements.append(Spacer(1, 3))
